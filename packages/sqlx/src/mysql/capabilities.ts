...
export const BASE_MYSQL_CAPS: CapabilityMatrix = {
    ddl: {
        createTable: true,
        alterTable: true,
        dropTable: true,
...
export function refineByServerVersion(base: CapabilityMatrix, versionString: string) {
    ...
    const caps: CapabilityMatrix = JSON.parse(JSON.stringify(base));
    // DML
